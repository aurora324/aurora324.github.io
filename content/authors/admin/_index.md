...
profiles:
  - icon: at-symbol
    ...
    label: E-mail Me
  - icon: brands/x
    url: https://x.com/wangbingqi62413
  - icon: brands/instagram
    url: https://www.instagram.com/bingqinwang520/
  - icon: brands/github
    url: https://github.com/aurora324
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/bingqin-wang-698a5b353/
...
education:
  - area: B.E. Computer Science and Engineering
    ...
    date_end: 2026-06-01
    summary: |
      Thesis on _Image Segmentation_. Supervised by [Prof Jiang Liu](https://www.sustech.edu.cn/en/faculties/liujiang.html). Presented papers at 5 IEEE conferences with the contributions being published in 2 Springer journals.
    # button:
    #   text: 'Read Thesis'
