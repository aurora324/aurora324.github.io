...
profiles:
  - icon: at-symbol
    url: 'mailto:wangbq2022@mail.sustech.edu.cn'
    label: E-mail Me
  - icon: brands/x
...
education:
  - area: B.E. Computer Science and Engineering
    ...
    date_end: 2026-06-01
    summary: |
      Thesis on _Image Segmentation_. Supervised by [Prof Jiang Liu](https://www.sustech.edu.cn/en/faculties/liujiang.html).
    # button:
    #   text: 'Read Thesis'
